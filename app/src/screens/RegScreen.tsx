...
const RegScreen = () => {
  ...
  var initialValues = {username: '', email: '', firstName: '', lastName: '' ,  password: '', userType:''};
  ...
  const regAPICall = (regValues: RegValues) =>{
    ...
    axios.post('http://10.0.2.2:5000/users', 
        ...
        <Text category='h1'>LOGIN</Text>
          ...
          >
            {({
              ...
              />
              { <Text style={styles.errorText}>{ (errors.firstName && touched.firstName) ? errors.firstName : '' }</Text> }
              ...
              />
              { <Text style={styles.errorText}>{ (errors.lastName && touched.lastName) ? errors.lastName : '' }</Text> }
              ...
              <TextInput    
                ...
                keyboardType="email-address"
              />
              { <Text style={styles.errorText}>{ (errors.userType && touched.userType) ? errors.userType : '' }</Text> }
